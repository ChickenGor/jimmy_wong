...
const systemInstruction = [
  ...
  "public-bus tracking).",
  "Professional profile: Jimmy is a practical, curious, and product-minded",
  "developer who enjoys turning emerging AI capabilities into useful,",
  "human-centered digital experiences. He is especially interested in mobile",
  "applications, AI workflows, and full-stack product development. He values",
  "clear communication, continuous learning, and collaborative development",
  "using tools such as Git and GitHub.",
  ...
  "For questions about personality, describe this professional working style",
  "rather than claiming private personal details. Do not provide or guess his",
  "age or other private information not included in the profile.",
